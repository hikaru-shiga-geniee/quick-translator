...
class TestQuickTranslator:
    ...
    def test_init(self, mocker):
        ...
        mock_get_api_key = mocker.patch.object(QuickTranslator, '_get_api_key', return_value='sk-test-key')
    ...
    def test_translate_with_api_no_key(self, mocker):
        ...
        with patch.object(QuickTranslator, '_get_api_key', return_value=None):
            ...
            with pytest.raises(ValueError, match="環境変数OPENAI_API_KEYが設定されていません"):
    ...
    def test_translate_with_api_curl_error(self, translator, mocker):
        ...
        mock_time = mocker.patch('time.time')
        mock_time.side_effect = [1000.0, 1002.0, 1003.0]  # Extra time call for error handling
